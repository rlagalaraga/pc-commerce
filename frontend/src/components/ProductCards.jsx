            ...
            <div>
                <div className='bg-black w-full max-h-[135px] p-6 flex text-lg'>
                    <div className='flex text-left w-full pr-[4px] text-sm sm:text-lg'>
                        ...
                        <button className='font-bebas ml-2 bg-slate-500 text-black w-[50px] sm:w-[100px] p-1 active:bg-[#FDF500]'>search</button>
                    </div>
                    <div className='font-bebas text-right w-full flex justify-end text-sm sm:text-lg'>
                        <div className='block'>
                            <button className='text-black bg-slate-500 p-1 w-[70px] sm:w-[200px] flex justify-between' onClick={() => setDropdown((prev) => !prev)}>Category {!dropdown ? (<AiOutlineCaretDown size={20}/>) : (<AiOutlineCaretUp size={20}/>)}</button>
                            {dropdown && (
                                <div className='w-[70px] sm:w-[200px] bg-slate-500 absolute text-black text-center'>
                                    <ul>
